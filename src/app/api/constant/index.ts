...
## 输出格式要求
请严格按照以下结构化纯文本格式输出，不要使用 Markdown 语法：

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
【正文内容】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

[正文内容，支持多段落，emoji使用丰富，段落之间用空行分隔]
...
注意：
- 使用纯文本格式，不要使用 Markdown 的 #、**、* 等符号
- 分隔线使用连续的 ━ 符号（Unicode: U+2501）
- 正文和标签部分必须用分隔线和标题明确区分
- 标签部分直接输出 #标签 格式，标签之间用空格分隔`;
